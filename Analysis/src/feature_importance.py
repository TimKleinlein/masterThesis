...
os.makedirs('data/feature_importance_consistent_plots', exist_ok=True)
with open('data/feature_importance_consistent_plots/average_token_attributions_crewmate.pkl', 'wb') as f:
    pkl.dump(average_token_attributions_crewmate, f)

with open('data/feature_importance_consistent_plots/average_token_attributions_impostor.pkl', 'wb') as f:
...
plt.figure(figsize=(12, 6))
plt.bar(top_tokens_crewmate_names, top_tokens_crewmate_scores, color='green', edgecolor='black')
plt.xlabel('Tokens')
plt.ylabel('Average Attribution')
plt.xticks(rotation=45, ha='right')  # Rotate labels by 45 degrees
plt.tight_layout()
plt.subplots_adjust(bottom=0.3)
plt.savefig('data/feature_importance_consistent_plots/top_tokens_crewmate_by_average_attribution.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.figure(figsize=(12, 6))
plt.bar(bottom_tokens_crewmate_names, bottom_tokens_crewmate_scores, color='red', edgecolor='black')
plt.xlabel('Tokens')
plt.ylabel('Average Attribution')
plt.xticks(rotation=45, ha='right')  # Rotate labels by 45 degrees
plt.tight_layout()
plt.subplots_adjust(bottom=0.3)
plt.savefig('data/feature_importance_consistent_plots/bottom_tokens_crewmate_by_average_attribution.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.figure(figsize=(12, 6))
plt.bar(top_tokens_impostor_names, top_tokens_impostor_scores, color='green', edgecolor='black')
plt.xlabel('Tokens')
plt.ylabel('Average Attribution')
plt.xticks(rotation=45, ha='right')  # Rotate labels by 45 degrees
plt.tight_layout()
plt.subplots_adjust(bottom=0.3)
plt.savefig('data/feature_importance_consistent_plots/top_tokens_impostor_by_average_attribution.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.figure(figsize=(12, 6))
plt.bar(bottom_tokens_impostor_names, bottom_tokens_impostor_scores, color='red', edgecolor='black')
plt.xlabel('Tokens')
plt.ylabel('Average Attribution')
plt.xticks(rotation=45, ha='right')  # Rotate labels by 45 degreesgit
plt.tight_layout()
plt.subplots_adjust(bottom=0.3)
plt.savefig('data/feature_importance_consistent_plots/bottom_tokens_impostor_by_average_attribution.png', dpi=300, bbox_inches='tight')
plt.close()
...
for i, utterance in enumerate(tqdm(crewmate_utterances, desc="Visualizing CREWMATE attributions")):
    attributions, delta = compute_attributions(utterance, 0)  # CREWMATE
    visualize_attributions(utterance, attributions, f'data/feature_importance_consistent_plots/crewmate_attribution_{i}.png')

for i, utterance in enumerate(tqdm(impostor_utterances, desc="Visualizing IMPOSTOR attributions")):
    attributions, delta = compute_attributions(utterance, 1)  # IMPOSTOR
    visualize_attributions(utterance, attributions, f'data/feature_importance_consistent_plots/impostor_attribution_{i}.png')

# Analyze token of question mark
with open('data/feature_importance_consistent_plots/average_token_attributions_crewmate.pkl', 'rb') as file:
    crewmate_attr = pkl.load(file)

with open('data/feature_importance_consistent_plots/average_token_attributions_impostor.pkl', 'rb') as file:

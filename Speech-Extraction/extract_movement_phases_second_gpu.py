                ...
                if s in streamers_of_lobby:
                    ...
                    for ind, mp in enumerate(relevant_movement_phases[ses][lob]):
                        ...
                        extract_segment(f'../../../../dimstore/pop520978/data/{ses}/{original_streamer_name}.mkv',
                                        f'{s}/{ses}_{lob}_{ind}.mkv', streamer_movement_start, streamer_movement_end)
                        convert_mkv_to_wav(f'{s}/{ses}_{lob}_{ind}.mkv', f'{s}/{ses}_{lob}_{ind}.wav')
                        if os.path.exists(f'{s}/{ses}_{lob}_{ind}.mkv'):
                            os.remove(f'{s}/{ses}_{lob}_{ind}.mkv')
...
unique_streamers_second_gpu = ['paulleewhirl', 'zeroyalviking', 'thecasperuk', 'therealshab', 'ressnie', 'karacorvus', 'pastaroniravioli', 'dooleynotedgaming', 'irepptar', 'courtilly', 'jvckk', 'jojosolos', 'kruzadar', 'dumbdog', 'kyr', 'atla5', 'reenyy', 'tenmamaemi', 'willyutv', 'chey', 'pwuppygf']


for s in unique_streamers_second_gpu:

...
sessions = ['2022-02-26_S1', '2022-03-01_S1', '2022-03-02_S1', '2022-03-03_S1',
            '2022-03-09_S1', '2022-03-10_S1', '2022-05-24_S1', '2022-05-24_S2']

for ses in sessions:

    lobbies = list(final_lobbies[ses].keys())
    for l in lobbies:
        pot_dis_starts = {}
        final_dic = {}
        ...
        for s in streamers:
            if final_lobbies[ses][l][s][0].days < 0:
                ...
                extract_segment(f'../../../../dimstore/pop520978/data/{ses}/{s}.mkv', f'{s}_l{l}.mkv', start_time, end_time)
